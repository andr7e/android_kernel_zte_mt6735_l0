...
int md_cd_io_remap_md_side_register(struct ccci_modem *md)
{
	...
	//md_ctrl->cldma_ap_base = ioremap_nocache(cldma_ctrl->hw_info->cldma_ap_base, CLDMA_AP_LENGTH);
	//md_ctrl->cldma_md_base = ioremap_nocache(cldma_ctrl->hw_info->cldma_md_base, CLDMA_MD_LENGTH);
