...
#include "ov13850mipiraw_ofg_Sensor.h"
...
//sensor otp
extern void otp_cali_ofg(unsigned char writeid);
...
static kal_uint32 open(void)
{
    ...
    sensor_init();
	  //for OTP
	  otp_cali_ofg(imgsensor.i2c_write_id);
	  write_cmos_sensor(0x0100, 0x00);
...
UINT32 OV13850_MIPI_RAW_ofg_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
