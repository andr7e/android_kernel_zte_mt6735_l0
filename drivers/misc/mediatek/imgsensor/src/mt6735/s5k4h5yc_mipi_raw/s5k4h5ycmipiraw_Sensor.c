...
extern void read_otp(void);
extern void apply_otp(void);
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb, //SENSOR_OUTPUT_FORMAT_RAW_R,//SENSOR_OUTPUT_FORMAT_RAW_Gr,
	.mclk = 24,
