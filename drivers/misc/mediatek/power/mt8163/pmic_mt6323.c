...
static ssize_t dump_ldo_status_read(struct file *file, char *page, size_t count, loff_t *data)
{
    char *p = page;
    kal_uint32 val_0=0, val_1=1;
...
static const struct file_operations ldo_status_fops =
{
	.owner = THIS_MODULE,
	.read = dump_ldo_status_read,
};
#else
