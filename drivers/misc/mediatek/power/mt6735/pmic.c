...
void PMIC_INIT_SETTING_V1(void)
{
    ...
    //--------------------------------------------------------
        ...
        PMICLOG("[Kernel_PMIC_INIT_SETTING_V1] 2015-05-27...\n");
...
ret = pmic_config_interface(0xF4A,0xD,0xF,4); // [7:4]: RG_VCDT_HV_VTH; Tim:VCDT_HV_th=7V
ret = pmic_config_interface(0xF4A,0x0,0xF,0); // [3:0]: RG_VCDT_LV_VTH; Tim:VCDT_LV_th=4.2V
