...
static const char* gM4U_SMILARB[] = {
	...
	"mediatek,SMI_LARB3", "mediatek,SMI_LARB5"};
...
m4u_port_t gM4uPort[] =
{
    ...
    { "CAM_IMG2O",                  M4U0_PORT_INIT( 0, 2,  1    ),    },
    { "CAM_LSCI",                   M4U0_PORT_INIT( 0, 2,  2    ),    },
    { "CAM_IMGI",                   M4U0_PORT_INIT( 0, 2,  3    ),    },
    { "CAM_ESFKO" ,                 M4U0_PORT_INIT( 0, 2,  4    ),    },
    { "CAM_AAO",                    M4U0_PORT_INIT( 0, 2,  5    ),    },
...
irqreturn_t MTK_M4U_isr(int irq, void *dev_id)
{
...

    {
		...
		unsigned int ptepa = 0;
            ...
            {
            	ptepa = m4u_dump_pte_nolock(m4u_get_domain_by_port(m4u_port), fault_mva);
