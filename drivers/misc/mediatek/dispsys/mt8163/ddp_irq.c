...
static struct task_struct *disp_irq_polling_task = NULL;    //add for early porting
#endif
...
#ifdef CONFIG_FPGA_EARLY_PORTING
        disp_irq_polling_task = kthread_create(disp_irq_polling_kthread_func, NULL, "ddp_irq_polling_kthread");
