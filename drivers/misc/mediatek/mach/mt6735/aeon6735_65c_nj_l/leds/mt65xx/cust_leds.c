...
#ifndef GPIO_LED_GREEN_CONTRL
#define GPIO_LED_GREEN_CONTRL (GPIO68|0x80000000)
#endif
int led_state = 0;
int custom_button_set_backlight( unsigned int  value)
{
	mt_set_gpio_mode(GPIO_LED_GREEN_CONTRL, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_LED_GREEN_CONTRL, GPIO_DIR_OUT);
	
//	printk("custom_button_set_backlight value=%d\n", value);
	if(value == 0) {
		led_state = 0;
		mt_set_gpio_out(GPIO_LED_GREEN_CONTRL, GPIO_OUT_ZERO);
	}
	else {
		led_state = 1;
		mt_set_gpio_out(GPIO_LED_GREEN_CONTRL, GPIO_OUT_ONE);
	}
	return 0;
}
/*
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	...
	{"green",             MT65XX_LED_MODE_GPIO, custom_button_set_backlight,{0}},
	{"blue",              MT65XX_LED_MODE_NONE, -1,{0}},
	{"jogball-backlight", MT65XX_LED_MODE_NONE, -1,{0}},
	{"keyboard-backlight",MT65XX_LED_MODE_NONE, -1,{0}},
//	{"button-backlight",  MT65XX_LED_MODE_PWM, PWM2,{1,1,30,30,0}},
