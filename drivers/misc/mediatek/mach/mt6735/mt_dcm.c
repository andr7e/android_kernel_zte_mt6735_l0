...
#define TOPCKG_DCM_CFG_MASK     ((0x1f<<0) | (1<<7) | (0x7f<<8) | (1<<15) \
                                 | (0x1f<<16) | (1<<21) | (1<<22) | (1<<23) | (0x7f<<24) | (1<<31))
#define TOPCKG_DCM_CFG_ON       ((0<<0) | (1<<7) | (0<<8) | (0<<15) \
                                 | (0<<16) | (1<<21) | (0x1<<22) | (1<<23) | (0<<24) | (0<<31))
#define TOPCKG_DCM_CFG_OFF       ((0<<7) | (1<<21) | (0<<23))
...
int dcm_topckg(ENUM_TOPCKG_DCM on)
{
        if (on) {
                ...
                reg_write(TOPCKG_DCM_CFG, aor(reg_read(TOPCKG_DCM_CFG), ~TOPCKG_DCM_CFG_MASK, TOPCKG_DCM_CFG_ON));
        }
        else {
                reg_write(TOPCKG_DCM_CFG, aor(reg_read(TOPCKG_DCM_CFG), ~TOPCKG_DCM_CFG_MASK, TOPCKG_DCM_CFG_OFF));
        }
...
#define ALL_DCM_TYPE  (ARMCORE_DCM_TYPE | MCUSYS_DCM_TYPE | INFRA_DCM_TYPE | PERI_DCM_TYPE |  \
                       EMI_DCM_TYPE | DRAMC_DCM_TYPE | TOPCKG_DCM_TYPE | EFUSE_DCM_TYPE )
