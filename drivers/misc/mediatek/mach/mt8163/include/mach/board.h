...
typedef void (*sdio_vender_irq_handler_t)(void*);  /* external irq handler */
...
struct msdc_hw {
    ...
    void (*request_sdio_eirq)(sdio_vender_irq_handler_t sdio_irq_handler, void *data);
    void (*enable_sdio_eirq)(void);
    void (*disable_sdio_eirq)(void);

    /* external cd irq operations */
    void (*request_cd_eirq)(sdio_vender_irq_handler_t cd_irq_handler, void *data);
