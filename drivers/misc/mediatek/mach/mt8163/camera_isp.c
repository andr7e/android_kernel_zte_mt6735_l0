...
typedef struct
{
    ...
    volatile ISP_EIS_META_STRUCT Eismeta[ISP_IRQ_TYPE_INT_STATUSX]; //eis meta only for p1 and p1_d
}ISP_IRQ_INFO_STRUCT;
            ...
            case ISP_RT_BUF_CTRL_CLEAR:
                ...
                switch(rt_dma){
                    ...
                    case _rrzo_:
                        ...
                        IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST].tLastSOF2P1done_sec=0;
                        IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST].tLastSOF2P1done_usec=0;
                    ...
                    case _rrzo_d_:
                        ...
                        IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST_D].tLastSOF2P1done_sec=0;
                        IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST_D].tLastSOF2P1done_usec=0;
...
static MINT32 ISP_WaitIrq(ISP_WAIT_IRQ_STRUCT* WaitIrq)
{
    ...
    {
        WaitIrq->EisMeta.tLastSOF2P1done_sec=IspInfo.IrqInfo.Eismeta[WaitIrq->Type].tLastSOF2P1done_sec;
        WaitIrq->EisMeta.tLastSOF2P1done_usec=IspInfo.IrqInfo.Eismeta[WaitIrq->Type].tLastSOF2P1done_usec;
    }
    //
...
//    do_gettimeofday(&time_ready2return);
    ...
    {
        WaitIrq->EisMeta.tLastSOF2P1done_sec=IspInfo.IrqInfo.Eismeta[WaitIrq->UserInfo.Type].tLastSOF2P1done_sec;
        WaitIrq->EisMeta.tLastSOF2P1done_usec=IspInfo.IrqInfo.Eismeta[WaitIrq->UserInfo.Type].tLastSOF2P1done_usec;
    }
    //time period for 3A
    if(WaitIrq->UserInfo.Status & IspInfo.IrqInfo.MarkedFlag[WaitIrq->UserInfo.UserKey][WaitIrq->UserInfo.Type])
    {
...
//    do_gettimeofday(&time_frmb);
    ...
    if(IrqStatus[ISP_IRQ_TYPE_INT_P1_ST] & ISP_IRQ_P1_STATUS_SOF1_INT_ST)
    {
        ...
        }
        {
            ...
            IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST].tLastSOF2P1done_sec=(unsigned int)(sec);
            IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST].tLastSOF2P1done_usec=(unsigned int) (usec);
    ...
    if(IrqStatus[ISP_IRQ_TYPE_INT_P1_ST_D] & ISP_IRQ_P1_STATUS_D_SOF1_INT_ST)
    {
        ...
        }
        {
            ...
            IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST_D].tLastSOF2P1done_sec=(unsigned int)(sec);
            IspInfo.IrqInfo.Eismeta[ISP_IRQ_TYPE_INT_P1_ST_D].tLastSOF2P1done_usec=(unsigned int) (usec);
            //
   ...
   //
    for(q=0;q<IRQ_USER_NUM_MAX;q++)
    {
        for(i=0; i<ISP_IRQ_TYPE_AMOUNT; i++)
        {
            ...
            {
                IspInfo.IrqInfo.Eismeta[i].tLastSOF2P1done_sec=0;
                IspInfo.IrqInfo.Eismeta[i].tLastSOF2P1done_usec=0;
            }
        }
    }
