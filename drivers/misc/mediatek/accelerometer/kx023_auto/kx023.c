...
#ifdef CONFIG_COMPAT
static long kx023_compat_ioctl(struct file *file, unsigned int cmd,
       unsigned long arg)
{
    long err = 0;
...
static struct file_operations kx023_fops = {
	...
	//.ioctl = kx023_ioctl,
#ifdef CONFIG_COMPAT
	.compat_ioctl = kx023_compat_ioctl,
#endif
};
/*----------------------------------------------------------------------------*/
...
//	struct hwmsen_object sobj;
	...
	if((err = kx023_init_client(new_client, 1)))               //yzb err
	{
