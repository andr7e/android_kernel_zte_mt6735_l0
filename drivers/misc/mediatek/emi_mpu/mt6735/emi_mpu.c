...
static const struct mst_tbl_entry mst_tbl[] =
{
    ...
    { .master = MST_ID_PERI_17, .port = 0x2, .id_mask = 0b1111111111, .id_val = 0b0000000101, .name = "PERI: GCE_M" },
    { .master = MST_ID_PERI_18, .port = 0x2, .id_mask = 0b1111110111, .id_val = 0b0000000110, .name = "PERI: CLDMA_MD" }, 
    { .master = MST_ID_PERI_19, .port = 0x2, .id_mask = 0b1111110111, .id_val = 0b0000000110, .name = "PERI: CLDMA_AP" },     
    ...
    { .master = MST_ID_C2KMCU_0, .port = 0x3, .id_mask = 0b1111111111, .id_val = 0b0000000111, .name = "MDMCU: CK2 MCUP+ HW:ARM D PORT" },
    { .master = MST_ID_C2KMCU_1, .port = 0x3, .id_mask = 0b1111111111, .id_val = 0b0000000011, .name = "MDMCU: CK2 MCUP+ HW:ARM I PORT" },  
    { .master = MST_ID_C2KMCU_2, .port = 0x3, .id_mask = 0b1111111111, .id_val = 0b0000100111, .name = "MDMCU: CK2 MCUP+ HW:DMA PORT" },  
...
#endif   
// Season: MT6735M will be enabled later
