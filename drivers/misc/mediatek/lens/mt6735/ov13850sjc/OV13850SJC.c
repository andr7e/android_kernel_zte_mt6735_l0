...
#define AF_DRVNAME "OV13850SJC"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x23
#define PLATFORM_DRIVER_NAME "lens_actuator_ov13850sjc"
#define AF_DRIVER_CLASS_NAME "actuatordrv_ov13850sjc"
...
inline static int getAFInfo(__user stOV13850SJC_MotorInfo * pstMotorInfo)
{
    stOV13850SJC_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stOV13850SJC_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stOV13850SJC_MotorMETAInfo * pstMotorMETAInfo)
{
    stOV13850SJC_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stOV13850SJC_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case OV13850SJCIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stOV13850SJC_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case OV13850SJCIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stOV13850SJC_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case OV13850SJCIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case OV13850SJCIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case OV13850SJCIOC_T_SETMACROPOS :
...
static int __init OV13850SJC_i2C_init(void)
{
...
static void __exit OV13850SJC_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(OV13850SJC_i2C_init);
module_exit(OV13850SJC_i2C_exit);

MODULE_DESCRIPTION("OV13850SJC lens module driver");
