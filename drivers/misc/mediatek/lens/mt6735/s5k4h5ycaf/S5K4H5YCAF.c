...
#define AF_DRVNAME "S5K4H5YCAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x22
#define PLATFORM_DRIVER_NAME "lens_actuator_s5k4h5ycaf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_s5k4h5ycaf"
...
inline static int getAFInfo(__user stS5K4H5YCAF_MotorInfo * pstMotorInfo)
{
    stS5K4H5YCAF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stS5K4H5YCAF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stS5K4H5YCAF_MotorMETAInfo * pstMotorMETAInfo)
{
    stS5K4H5YCAF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stS5K4H5YCAF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case S5K4H5YCAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stS5K4H5YCAF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case S5K4H5YCAFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stS5K4H5YCAF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case S5K4H5YCAFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case S5K4H5YCAFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case S5K4H5YCAFIOC_T_SETMACROPOS :
...
static int __init S5K4H5YCAF_i2C_init(void)
{
...
static void __exit S5K4H5YCAF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(S5K4H5YCAF_i2C_init);
module_exit(S5K4H5YCAF_i2C_exit);

MODULE_DESCRIPTION("S5K4H5YCAF lens module driver");
